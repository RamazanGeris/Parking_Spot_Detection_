...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Cihat\Desktop\Parking_Spot_Detection'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Cihat\Desktop\Parking_Spot_Detection\Scripts\deactivate.nu'
